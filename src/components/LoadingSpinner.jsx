  ...
  const spinner = (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px' }}>
      ...
      <div style={{ position: 'relative', width: 68, height: 68 }}>
        ...
        {/* Mask to create ring */}
        <div style={{ position: 'absolute', inset: 6, borderRadius: '9999px', background: 'var(--bg, #fff)' }} />
        {/* Inner rotating arc */}
        <div style={{
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ width: 10, height: 10, borderRadius: '9999px', background: '#facc15', boxShadow: '0 0 18px rgba(250, 204, 21, 0.8)', animation: 'pulse 1.2s ease-in-out infinite' }} />
        </div>
      </div>
      <p style={{ color: '#64748b', fontWeight: 600, letterSpacing: '0.02em' }}>{label}</p>
    </div>
  );
